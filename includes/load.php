...
/**
 * Created by Gerald Kiwelu adding ss4 form @ Ifakara Health Insitute (2021)
 **/
...
if(isset($_SESSION['expcode'])){
  ...
  //Other tables tables for activities, substrate and wilddomestic animal are added
