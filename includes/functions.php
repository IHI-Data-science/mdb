...
function sendMail($email, $message, $subject){
 ...
 // $mail->addReplyTo('', '');
  ...
  function createtables($prefix){
    ...
    $sql .= "CREATE TABLE IF NOT EXISTS ".$prefix."ss2 (
      ...
      `hf` varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of Habitat found (1: Yes, 2: No)',
      `hbt`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of Habitat types ( names)',
      `htc` varchar(30)unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of Habitat type correct (1: Yes, 2: No)',
      `ht` varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of Habitat Type treated (1: Yes, 2: No)',
      `hw` varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of Habitat wet (1: Yes, 2: No)',
      `hs`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status Habitat Parameter (1: <10m, 2: 10-100m, 3: >100m)',
      `dnh`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of distance next house (measured in steps)',
      `fr` int(2) NOT NULL COMMENT 'unique identifier of each row on the data collected',
      `dip`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'number of dipping effort (dio)',
      `tx` int(3) NOT NULL DEFAULT '-99' COMMENT 'taxon identification number',
      `bfegg`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'larvae stage  (measured in steps)',
      `bfl1`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'larvae stage 1 (l1)',
      `bfl2`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'larvae stage 2 (l2)',
      `bfl3`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'larvae stage 3 (l3)',
      `bfl4`varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'larvae stage 4 (l4)',
      ...
      `vt` varchar(30) unsigned NOT NULL DEFAULT '1' COMMENT 'Hold status of treated (1: Yes, 2: No)',
 ...
 `ph` varchar(15) DEFAULT NULL COMMENT 'potential of hydrogen',
    ...
    $sql .= "CREATE TABLE IF NOT EXISTS ".$prefix."ss2template(
      ...
      `dip` varchar(30) NULL,
      `tx` varchar(20) NULL,
      `bfegg` varchar(10) NULL,
      `bfl1` varchar(30) NULL,
      `bfl2` varchar(30) NULL,
      `bfl3` varchar(30) NULL,
      `bfl4` varchar(10) NULL,
      `l1l2` varchar(10) NULL,
      `l3l4` varchar(10) NULL,
      `tlv` varchar(10) NULL,
      `pu` varchar(10) NULL,
      `vl` varchar(10) NULL,
      `rl` varchar(10) NULL,
