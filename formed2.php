...
$page_title='Experimental Design';
                       ...
                       <form method="post" action="">
                           ...
                           <div class="form-actions text-center">
                               ...
                               <div class="center-block" style="width:300px">
                                   <select class="select-full" name="site_id"
                                           id="site_id"> </select>
                               </div>
                                   ...
                                   <div class="input-group">
                                       <div class="input-group-btn">
                                           <button id="upload" type="button"
                                                   class="btn custom-btn btn-primary"><span><i
                                                      class="fa fa-upload"></i> Upload File</span>
                                           </button>
                                       </div>
                                       <input id="status" type="text"
                                              class="form-control field-heightc"
                                              disabled="disabled">
                                   </div>
                               </div>
                           </div>
                           ...
                           <div class="form-actions text-center">
                               <button name="submit" type="submit" id="submit" value="Save"
                               ...
                               if(count($arraycsv1)==count($arraypattern)){
                                  ...
                                  foreach($csv as $key=>$line){
                                     ...
                                     elseif($rowtype==3/* && $pass ==1*/){
                                        ...
                                        $query="INSERT INTO $ed1 (projectregsite_id, $patternattribute) VALUES('$projectregsite','$linearray')";
                                        //echo $query."<br />";
                                        //execute query
