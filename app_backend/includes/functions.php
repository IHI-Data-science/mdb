...
function ss2data($sen, $ssen, $sfr, $hf, $hbt,$ht, $hw, $hs,$dnh, $fr,$dip, $tx, $bfegg,$bfl1,$bfl2,$bfl3,$bfl4,$l1l2,$l3l4,$tlv, $pu, $vl,$rl, $vt,$notes, $slc, $ni, $nb, $sid01, $sid02, $sid03, $sid04, $sid05, $sid06, $sid07, $nod)
{
    global $db;
