...
function ed1data($sen,$fr,$dt,$re,$ea,$cr,$cp,$hh,$nah,$sid,$me,$ind,$htr,$st,$ft,$hp,$rnd,$blk,$shh,$stn,$vi,$tr,$dy,$tmp,$hmd,$ws,$oth,$vc,$notes,$su,$dso,$sa,$hos,$dr,$ph,$co,$wda,$act,$hc,$dsen) {
...
function ss1data($sen, $ssen, $sfr, $bf, $fr,$tx, $sas, $n, $notes, $slc,
 $nd, $No_Batches, $st2sid01, $st2sid02, $st2sid03,  $st2sid04,$st2sid05, $st2sid06, $st2sid07,$No_Discarded) {
