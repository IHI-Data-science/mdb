 ...
 <!-- Page header -->
  <div class="container-fluid">
      <div class="page-header">
          <div class="logo"><a href="home.php" title=""><img src="assets/images/logo0.png" alt="logo" ></a>
            <div class="bottom-align-text text-center">
               <h5><?php echo $settings['organization_name']; ?></h5>
             </div>
          </div>
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu"><a tabindex="-1" href="#"><b class="caret-right"></b>Sample Sorting</a>
                              <ul class="dropdown-menu">
                                ...
                                <li class="<?php echo $disabless4; ?>"><a tabindex="-1" href="datatabless3.php">Sample Sorting 4</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu"><a tabindex="-1" href="#"><b class="caret-right"></b>Sample Observation</a>
                              <ul class="dropdown-menu">
